...
DATABASES = {
    'default': {
        ...
        'NAME': 'django_site',  # (create database test) in mysql
        'USER': 'user',  #username of mysql
        'PASSWORD': 'password',  #password of mysql
        'HOST': 'localhost',  # remote ip
        'PORT': '13306',  # remote port , find it from /etc/mysql/my.cnf
        'OPTIONS': {
...
SESSION_COOKIE_SECURE = False # @todo must set True before usage for the difference of http and https.(http->false https->true)
